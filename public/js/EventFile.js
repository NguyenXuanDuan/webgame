...
function Click(id) {
    ...
    var win = WinGame();
    var pwin = CPlayer;
    var idScoreX = document.getElementById("scoreX");
    var idScoreO = document.getElementById("scoreO");
    ...
    if (win) {
        ...
        if (pwin == 0) {
            Oscore += 10;
            idScoreO.innerHTML = Oscore;
        } else {
            Xscore += 10;
            idScoreX.innerHTML = Xscore;
        }
    } else {
